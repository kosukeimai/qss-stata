...
set maxvar 10000
cd discovery
nwclear // clear networks from memory
...
nwplot marriage, size(near_out) ///
	label(family) title("Closeness (non-normalized)", margin(b = 4)) ///
...
*************************************************************
/** 7.2.3 Colors in Stata **/
*************************************************************
palette color blue blue*.5

*************************************************************
/** 7.2.4 United States Presidential Elections **/
*************************************************************
use pres08, clear
...
*************************************************************
/* 7.2.6 Animation in Stata **/
*************************************************************
/* Animation depends on operating system
* create directory to store graphs
mkdir graphs // add only if not already created

* loop through and create graph for each year
...
// Unix commands
local input: dir "" files "*.png" // get list of graphs
...
*************************************************************
/** 7.3.3 Document-Matrix and Clusters **/
*************************************************************
